                ...
                <table class="table table-striped table-responsive">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Οικονομικά Ενήμερος</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="form-check form-switch d-flex align-items-center">
                                        <input class="form-check-input econ-switch me-2" type="checkbox" role="switch"
                                            id="switch<?= $department_member['user_id'] ?>"
                                            data-user-id="<?= $department_member['user_id'] ?>"
                                            <?= $department_member['economical_ok'] ? 'checked' : '' ?>>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <a class="btn" data-bs-toggle="collapse"
                                                        href="#collapseOne<?php echo $department_member['user_id']; ?>">
                                                        Καλύψεις
                                                    </a>
                                                </div>
                                                <div id="collapseOne<?php echo $department_member['user_id']; ?>"
                                                    class="collapse"
                                                    data-bs-parent="#accordion<?php echo $department_member['user_id']; ?>">
                                                    <div class="card-body">
                                                        <table class="table">
                                                            <thead>
                                                                <tr>
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    <a class="collapsed btn" data-bs-toggle="collapse"
                                                        href="#collapseTwo<?php echo $department_member['user_id']; ?>">
                                                        Εκπαιδεύσεις
                                                    </a>
                                                </div>
                                                <div id="collapseTwo<?php echo $department_member['user_id']; ?>"
