...
<div class="container-fluid eod-patras">
	...
	<div class="row">
		...
		<div class="col-4">
			<span><?php echo character_limiter($patras_department['sub_description'], 350);?>
						<a href="<?= base_url('/departments/view_patras_department/' . $patras_department['id']) ?>" class="see-more-btn col-12">
								<div>
									Δείτε Περισσότερα
								</div>
						</a></span>
